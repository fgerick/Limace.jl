...
@inline function bcs_p(b::Basis{ViscousNoBC, Sphere})
    fs = (
        #   @inline((l,n)->s(Basis{ViscousNoBC, Sphere}, b.V, l, 0, n, b.V.r1)),
          @inline((l,n)->∂(r->s(Basis{ViscousNoBC, Sphere}, b.V, l, 0, n, r), b.V.r1)), 
          )
    return fs
end

@inline function bcs_t(b::Basis{ViscousNoBC, Sphere})
    fs = (@inline((l,n)->t(Basis{ViscousNoBC, Sphere}, b.V, l, 0, n, b.V.r1)), )
    return fs
end


lpmax(b::Basis{ViscousNoBC, Sphere}) = b.N-1
ltmax(b::Basis{ViscousNoBC, Sphere}) = b.N
