...
"""
@inline function t(::Type{Basis{Inviscid, Sphere}}, V::Sphere, l,m,n,r)
...
"""
@inline function s(::Type{Basis{Inviscid, Sphere}}, V::Sphere, l,m,n,r)
    fac = sqrt(5+2l+4n)/sqrt(4l*(l+1)*(n+1)^2)
    return (1-r^2)*r^l*jacobi(n,1,l+1/2, 2r^2-1)*fac
end

@inline _nrange_p(b::Basis{Inviscid,Sphere},l) = 0:((b.N-l+1)÷2-1)
@inline _nrange_t(b::Basis{Inviscid,Sphere},l) = 0:((b.N-l)÷2)

@inline lpmax(b::Basis{Inviscid,Sphere}) = b.N
@inline ltmax(b::Basis{Inviscid,Sphere}) = b.N

_lmn2cdeg_p(u::Basis{Inviscid,Sphere}, l,m,n) = l+2n+1
_lmn2cdeg_t(u::Basis{Inviscid,Sphere}, l,m,n) = l+2n
...
function _coriolis_poloidal_poloidal!(b::Basis{Inviscid,Sphere}, is, js, aijs, lmn2k_p, l, m, r, wr, Ω::T) where T
...
function _coriolis_poloidal_toroidal!(b::Basis{Inviscid,Sphere}, is, js, aijs, _np, lmn2k_p, lmn2k_t, l, l2, m, r, wr, Ω::T) where T
...
function _coriolis_toroidal_toroidal!(b::Basis{Inviscid,Sphere}, is, js, aijs, _np, lmn2k_t, l, m, r, wr, Ω::T) where T
...
function _coriolis_toroidal_poloidal!(b::Basis{Inviscid,Sphere}, is, js, aijs, _np, lmn2k_t, lmn2k_p, l, l2, m, r, wr, Ω::T) where T
...
function inertial(b::Basis{Inviscid,Sphere}; kwargs...)
